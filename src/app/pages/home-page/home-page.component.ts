...
export class HomePageComponent {
    ...
    changeTraditional() {
        this.traditionalProperty = 'Alex';
    }

    changeSignal() {
        this.signalProperty.set('Alex');
    }
    ...
    afterNextRenderEffect = afterNextRender(() => log('afterNextRender', "Runs once the next time that all components have been rendered to the DOM."));

    afterEveryRenderEffect = afterEveryRender(() => log('afterEveryRender', "Runs every time all components have been rendered to the DOM."));
}
